...
class BMICalculator:
    def __init__(self, root):
        ...
        self.save_button = tk.Button(root, text="Save Data", command=self.save_data, bg="#ffffff", fg="#0B57D0",
                                     font=("Arial", 12))
        ...
        self.exit_button = tk.Button(root, text="Exit", command=self.root.destroy, bg="#EF6A6A", fg="#181414",
                                     font=("Arial", 12))
    ...
    def save_data(self):
        try:
            ...
            with open("bmi_data.csv", "a", newline="") as file:
                ...
                writer.writerow([self.username_entry.get(), weight, height, bmi, category])

            messagebox.showinfo("Data saved", "Your data has been saved to bmi_data.csv")
        except ValueError:
            messagebox.showerror("Invalid input", "Please enter valid numbers for weight and height.")
